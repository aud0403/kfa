...
select '20190131' AS ldadng_de
  ...
  from (select distinct stdr_year 
		  ...
		  from kfadm.wf_player_sttus
		 where stdr_year = '2019'
		   and psitn_team_grad_cde IN ('UC1','UC2','UC3'))a
		left outer join 
		(select distinct stdr_year
		      , psitn_team_id
		      , player_id
